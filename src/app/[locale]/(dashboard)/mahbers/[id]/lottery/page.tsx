...
export default function LotteryPage({
  ...
  const drawMutation = useMutation({
    mutationFn: () => financialService.drawLottery(id),
    onMutate: () => {
      setIsDrawing(true);
        ...
        <CardContent className="p-8 md:p-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-4 text-center md:text-left">
            ...
            <p className="text-text-secondary max-w-md">
              ...
              the current Equb cycle. Only members who haven't won yet will be
                ...
                >
                  <CardContent className="p-0">
                    <div className="flex items-center p-4 sm:p-6 gap-4 sm:gap-6">
                      <div
                        className={`shrink-0 flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full ${isNewlyDrawn ? "bg-gold text-background-dark" : "bg-surface-active text-gold"}`}
                      >
                        {isNewlyDrawn ? (
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        <div
                          className={`text-xl sm:text-2xl font-bold ${isNewlyDrawn ? "text-gold" : "text-text-primary"}`}
                        >
