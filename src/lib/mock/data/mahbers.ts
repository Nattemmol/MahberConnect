...
export const mockMahbers: Mahber[] = [
  {
    ...
    configuration: { contribution_amount: 5000, cycle: "monthly" },
  ...
  },
  {
    ...
    configuration: { contribution_amount: 100, cycle: "monthly" },
  ...
  },
  {
    ...
    is_public: true,
    invitation_code: null,
    configuration: { contribution_amount: 250, cycle: "quarterly" },
